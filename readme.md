...
- **OpenXR Compatibility:** Works natively with the vast majority of modern headsets (Oculus, SteamVR, etc.).
...
5. Once finished, open the desktop shortcut to launch the VR Launcher. From there you can select and run any chapter you have available.
